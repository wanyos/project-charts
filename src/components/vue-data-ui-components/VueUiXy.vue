...
// onMounted(() => {
//   // dataset.push(props.dataType)
//   // console.log('data prop', props.dataType)
//   // pr.value = props.dataType
//   // // dataset.value.push(props.dataType)
...
const config = ref({
  ...
  chart: {
    ...
    legend: { show: false, color: '#c8c8c8', fontSize: 10 },
    // title: {
    //   show: false,
    //   text: 'Title',
    //   color: '#c8c8c8',
